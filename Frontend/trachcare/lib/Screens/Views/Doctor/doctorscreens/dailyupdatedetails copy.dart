...
import 'package:trachcare/Screens/Views/Doctor/doctorscreens/calender%20copy.dart';
...
class d_Viewdailyupdates extends StatefulWidget {
   final String name;
  final String imagePath;
  final String selecteddate;
  final String patientId; // Assuming patientId is passed in as well

  d_Viewdailyupdates({super.key,required this.name, required this.imagePath, required this.selecteddate, required this.patientId});

  @override
  _d_ViewdailyupdatesState createState() => _d_ViewdailyupdatesState();
}

class _d_ViewdailyupdatesState extends State<d_Viewdailyupdates> {
      ...
      NormalAppbar(
          ...
          onTap: () {
            Navigator.of(context).pushReplacement(
              MaterialPageRoute(
                builder: (context) => d_CalendarScreen(
